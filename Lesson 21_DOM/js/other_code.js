...
//select first view (section -> 12 divs)d
...
//changing styles
//showing second view and hiding first view
...
//showing first view and hiding second view
view1.style.display = "flex";
view2.style.display = "none"

//showing view1 and view2
view1.style.display = "flex";
view2.style.display = "flex";

//hiding view1 and view2
view1.style.display = "none";
view2.style.display = "none";
...
//change alignment
navbar.style.justifyContent = "flex-start"; //send everything to the left or start
navbar.style.justifyContent = "flex-end"; //send everything to the right or end
navbar.style.justifyContent = "space-evenly"; //center elements by adding equal space from both sides
